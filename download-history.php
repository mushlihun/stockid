...
if(substr($_SESSION['level'],0,6)=='gudang')
{
	...
	$sql="select t.tgl_transaksi,b.nama_barang,b.satuan,t.jenis_transaksi,g.nama_gudang,t.no_do,t.jumlah,t.keterangan from transaksi t, barang b, gudang g where (t.id_barang=b.id_barang) and (t.id_gudang=g.id_gudang) and (t.id_gudang=$idgudang) order by t.id_transaksi desc limit 0,100";
}
else
{
	$sql="select t.tgl_transaksi,b.nama_barang,b.satuan,t.jenis_transaksi,g.nama_gudang,t.no_do,t.jumlah,t.keterangan from transaksi t, barang b, gudang g where (t.id_barang=b.id_barang) and (t.id_gudang=g.id_gudang) order by t.id_transaksi desc limit 0,100";				
}
